...
int solution(vector<int> sticker)
{
    ...
    auto linearDP = [&](int start, int end)
    {
        ...
        {
            int curr = max(prev1, prev2 + sticker[i]);
            prev2 = prev1;
            prev1 = curr;
        }
        return prev1;
    ...
    int caseA = linearDP(0, n - 1);
    int caseB = linearDP(1, n);
...
int main()
{
    ...
    vector<int> sticker2 = {1, 3, 2, 5, 4};

    cout
        << solution(sticker) << endl
        << solution(sticker2) << endl;
